...
{
    self.skyDriveModel = skyDriveModel;
    self.skyDriveModel.delegate = self;

    self.folderId = folderId;

    if (folderId)
        [self.skyDriveModel getFolderWithId:folderId];
}
...
-(void)segueToFolderWithId:(NSString *)folderId
{
    ...
    [vcFolderTable setSkyDriveModel:self.skyDriveModel andFolderId:folderId];
